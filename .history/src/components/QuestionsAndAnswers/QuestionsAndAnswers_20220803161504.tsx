...
const QuestionsAndAnswers: React.FunctionComponent<IQuestionsAndAnswersProps> = ({
	...
	const questionElements = QnaArray.map((question: {
		...
		<Question key={question.id} id={question.id} question={question.question} correctAnswer={question.correct_answer} incorrectAnswer={""} difficulty={""} category={""} selectedAnswer={""} showAnswer={""} handleSelectAnswer={function (): void {
